    ...
    return (
       ...
       <div ref={myRef} className={"container"}>
            ...
            <motion.div className="restSkills"
                ...
                transition={showRest ? {duration: 1, delay: 0.5, transition: "linear"} : {duration: 1, delay: 0.5, transition: "linear"}}
            >
                {RestSkills}
            </motion.div>
